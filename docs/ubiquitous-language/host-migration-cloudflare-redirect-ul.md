...
| Shared Stat-Counter Action | `AnimationManager.actions.animateStatCounter`, the single implementation shipped by `@ksimonnet/utils` 2.1.0 or later. | A consumer-local `animateStatCounter` function or helper module. |
...
| REQ-B2B-003 | Shared Stat-Counter Action |
| REQ-B2C-014 | Shared Stat-Counter Action |
| CON-B2B-002 | Shared Stat-Counter Action |
| CON-B2C-007 | Shared Stat-Counter Action |
